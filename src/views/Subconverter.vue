...
export default {
    ...
    var data = {
      ...
      options: {
        ...
        customBackend: {
          ...
          "ccph3000subconverter.vercel.app(ccph3000自建)": "https://ccph3000subconverter.vercel.app/sub?",
        ...
        backendOptions: [
          ...
          { value: "https://ccph3000subconverter.vercel.app/sub?" },
  ...
  mounted() {
    ...
    this.form.customBackend = "https://ccph3000subconverter.vercel.app/sub?";
